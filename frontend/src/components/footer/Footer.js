...
function FooterLinks(){
    ...
    const links = [
      { to: "/contact/", icon: "/static/frontend/svg/contact.svg", iconAlt: "Contact Icon", title: "Contact", text: "Contact Admin" },
      { to: "https://github.com/VBoB13/TeachAdmin", target: "_blank", rel: "noreferrer noopener", icon: "/static/frontend/svg/kitty(small).svg", iconAlt: "Custom GitHub Icon",
        title: "GitHub", text: "View the site's GitHub repository."}
    ];
